 ...
 * will inherit from this class. E.g Ball, Brick, Player etc.
 * 
 */
public abstract class GameObject {
	...
	/**
	 * Changes the objects up/down Direction. If the object is going down, this
	 * will cause the object to go up. And vice versa.
	 * 
	 * 
	 */
	...
	/**
	 * Changes the objects left/right Direction. If the object is going left,
	 * this will cause the object to go right. And vice versa.
	 * 
	 * 
	 */
	...
	/**
	 * If the object gets hit, do what needs to be done. For example decrease
	 * the health of a brick if it gets hit;
	 * 
	 * @param o
	 *            GameObject
	 */
